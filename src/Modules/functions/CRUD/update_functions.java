...
public class update_functions {
    ...
    public static void update_events(Events ev){
        ...
        if (Singleton.events.isEmpty()) {
            ...
            ev = functions_makeup.events_id("¿Cuál es el identificador del servicio que desea cambiar?");
            ...
            if(location != -1){
                ...
                functions_makeup.update(ev);

                Singleton.events.set(location, ev);
